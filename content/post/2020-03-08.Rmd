...
Remove shinyUI(). As of Shiny .10 it is no longer needed. Any way to make our files less complicated only helps.&nbsp;
...
Remove shinyServer(). As of Shiny .10 it is no longer needed.&nbsp;
...
Say we wanted to make the plot below with the ability to select the class of car? (example from R for Data Sceince by Garrett Grolemund and Hadley Wickham)
